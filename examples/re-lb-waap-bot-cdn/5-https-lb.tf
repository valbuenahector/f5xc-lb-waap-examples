...
resource "volterra_http_loadbalancer" "lb-app1-tf" {
    depends_on = [volterra_origin_pool.pool-tf-juiceshop, volterra_app_firewall.waap-tf, volterra_cdn_loadbalancer.cdn-distri-app1-tf]
    ...
    domains = ["apptf1-waap-cdn.wwt.xcsdemo.com"]
